...
SUITE(Number compares)
{
   ...
   Case(get rectangle diag length-- failure)
   {
      ...
      rectangle_t p2 = {1, 1};
      OK(1.41, rectangle_diag(&p2));  //1.41421356237 failure
   };

   Case(test for great than -- successful)
   {
      rectangle_t p1 = {2, 3};
...
{
   OK("a7af3452a5eee24a149f8993e48ce81b77b200b212b23c2402c221ddc4260a608cf328a2133386477eb7a65958893726741cb9223419a7a0224fe7af2866944197ee4ab18e25913cae8507bb306a284f",
