...
SUITE(equation matches)
{
   ...
   Case(boolean)
   {
      ...
      OK(nullptr == a1.matches(false, 0, {}));
      h2::h2_equation<const bool> a2(false);
      OK(nullptr == a2.matches(false, 0, {}));
   }
   ...
   Case(float percentage approximate)
   {
      ...
      OK(nullptr == a1.matches(65.1, 0, {}));
      h2::h2_equation<double> a2(65.0, 0.1_p);  // 10%
      OK(nullptr == a2.matches(66, 0, {}));
   }
}
