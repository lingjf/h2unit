...
SUITE(equation matches)
{
   Case(Equal)
   {
      ...
      OK(nullptr == a1.matches(123, 0, false, false, false));
      h2::h2_equation<const int> a2(123);
      OK(nullptr == a2.matches(123, 0, false, false, false));
      h2::h2_equation<unsigned long long> a3(123);
      OK(nullptr == a3.matches(123, 0, false, false, false));

      h2::h2_equation<bool> b1(false);
      OK(nullptr == b1.matches(false, 0, false, false, false));
      h2::h2_equation<const bool> b2(false);
      OK(nullptr == b2.matches(false, 0, false, false, false));

      h2::h2_equation<float> c1(65.000000001);
      OK(nullptr == c1.matches(65, 0, false, false, false));
      h2::h2_equation<double> c2(65.000000001);
      OK(nullptr == c2.matches(65, 0, false, false, false));
      h2::h2_equation<double> c3(65.000000001, 0.001);
      OK(nullptr == c3.matches(65, 0, false, false, false));
      h2::h2_equation<double> c4(65.001, 0.0001);
      OK(nullptr != c4.matches(65, 0, false, false, false));
