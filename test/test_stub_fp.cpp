...
SUITE(normal fp)
{
   ...
   Case(one candidate)
   {
      fp = h2::h2_fp<int(int, const char*)>::get(foobar2);
      OK(fp);
   ...
   Case(two candidate)
   {
      fp = h2::h2_fp<int(int)>::get(foobar3);
      OK(fp);
      int (*fa)(int) = (int (*)(int))fp;
      OK(3, fa(0));

      fp = h2::h2_fp<const char*(const char*)>::get(foobar3);
      OK(fp);
...
SUITE(constructible and destructible)
{
   Case(constructible)
   {
      ...
      OK(Not(nullptr), c_OverrideClass);
...
SUITE(mfp for static member function)
{
   ...
   {
      void* A_AbstractClass__static_f1 = h2::h2_fp<A_AbstractClass, const char*(int)>::get(&A_AbstractClass::static_f1);
      OK(Not(nullptr), A_AbstractClass__static_f1);
   ...
   {
      void* B_DerivedClass__static_f1 = h2::h2_fp<B_DerivedClass, const char*(int)>::get(&B_DerivedClass::static_f1);
      OK(Not(nullptr), B_DerivedClass__static_f1);
      ...
      void* B_DerivedClass__static_f2 = h2::h2_fp<B_DerivedClass, const char*(int, int)>::get(&B_DerivedClass::static_f2);
      OK(Not(nullptr), B_DerivedClass__static_f2);
   ...
   {
      void* C_OverrideClass__static_f1 = h2::h2_fp<C_OverrideClass, const char*(int)>::get(&C_OverrideClass::static_f1);
      OK(Not(nullptr), C_OverrideClass__static_f1);
      ...
      void* C_OverrideClass__static_f2 = h2::h2_fp<C_OverrideClass, const char*(int, int)>::get(&C_OverrideClass::static_f2);
      OK(Not(nullptr), C_OverrideClass__static_f2);
   ...
   {
      void* D_NoConstructorClass__static_f3 = h2::h2_fp<D_NoConstructorClass, const char*(int, int, int)>::get(&D_NoConstructorClass::static_f3);
      OK(Not(nullptr), D_NoConstructorClass__static_f3);
...
SUITE(mfp for normal member function)
{
   ...
   Case(abstract class)
   {
      void* A_AbstractClass__normal_f1 = h2::h2_fp<A_AbstractClass, const char*(int)>::get(&A_AbstractClass::normal_f1);
      OK(Not(nullptr), A_AbstractClass__normal_f1);
   ...
   Case(derived class)
   {
      void* B_DerivedClass__normal_f1 = h2::h2_fp<B_DerivedClass, const char*(int)>::get(&B_DerivedClass::normal_f1);
      OK(Not(nullptr), B_DerivedClass__normal_f1);
      ...
      void* B_DerivedClass__normal_f2 = h2::h2_fp<B_DerivedClass, const char*(int, int)>::get(&B_DerivedClass::normal_f2);
      OK(Not(nullptr), B_DerivedClass__normal_f2);
   ...
   Case(override class)
   {
      void* C_OverrideClass__normal_f1 = h2::h2_fp<C_OverrideClass, const char*(int)>::get(&C_OverrideClass::normal_f1);
      OK(Not(nullptr), C_OverrideClass__normal_f1);
      ...
      void* C_OverrideClass__normal_f2 = h2::h2_fp<C_OverrideClass, const char*(int, int)>::get(&C_OverrideClass::normal_f2);
      OK(Not(nullptr), C_OverrideClass__normal_f2);
...
SUITE(mfp for virtual member function)
{
   ...
   Case(abstract class)
   {
      void* A_AbstractClass__virtual_f1 = h2::h2_fp<A_AbstractClass, const char*(int)>::get(&A_AbstractClass::virtual_f1);
      OK(Not(nullptr), A_AbstractClass__virtual_f1);
   ...
   {
      void* A_AbstractClass__virtual_f1 = h2::h2_fp<A_AbstractClass, const char*(int)>::get(a, &A_AbstractClass::virtual_f1);
      OK(Not(nullptr), A_AbstractClass__virtual_f1);
      typedef const char*(TEST__thiscall * A_AbstractClass__virtual_f1_Type)(A_AbstractClass*, int);
      OK("A.virtual_f1(1)a", ((A_AbstractClass__virtual_f1_Type)A_AbstractClass__virtual_f1)(a, 1));
   }
   ...
   Case(derived class)
   {
      void* B_DerivedClass__virtual_f1 = h2::h2_fp<B_DerivedClass, const char*(int)>::get(&B_DerivedClass::virtual_f1);
      OK(Not(nullptr), B_DerivedClass__virtual_f1);
      ...
      void* B_DerivedClass__virtual_f2 = h2::h2_fp<B_DerivedClass, const char*(int, int)>::get(&B_DerivedClass::virtual_f2);
      OK(Not(nullptr), B_DerivedClass__virtual_f2);
   ...
   Case(override class)
   {
      void* C_OverrideClass__virtual_f1 = h2::h2_fp<C_OverrideClass, const char*(int)>::get(&C_OverrideClass::virtual_f1);
      OK(Not(nullptr), C_OverrideClass__virtual_f1);
      ...
      void* C_OverrideClass__virtual_f2 = h2::h2_fp<C_OverrideClass, const char*(int, int)>::get(&C_OverrideClass::virtual_f2);
      OK(Not(nullptr), C_OverrideClass__virtual_f2);
   ...
   {
      void* D_NoConstructorClass__virtual_f1 = h2::h2_fp<D_NoConstructorClass, const char*(int)>::get(&D_NoConstructorClass::virtual_f1);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f1);
      ...
      void* D_NoConstructorClass__virtual_f2 = h2::h2_fp<D_NoConstructorClass, const char*(int, int)>::get(&D_NoConstructorClass::virtual_f2);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f2);
      ...
      void* D_NoConstructorClass__virtual_f3 = h2::h2_fp<D_NoConstructorClass, const char*(int, int, int)>::get(&D_NoConstructorClass::virtual_f3);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f3);
   ...
   {
      void* D_NoConstructorClass__virtual_f1 = h2::h2_fp<D_NoConstructorClass, const char*(int)>::get(&d, &D_NoConstructorClass::virtual_f1);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f1);
      typedef const char*(TEST__thiscall * D_NoConstructorClass__virtual_f1_Type)(D_NoConstructorClass*, int);
      OK("D.virtual_f1(1)d", ((D_NoConstructorClass__virtual_f1_Type)D_NoConstructorClass__virtual_f1)(&d, 1));

      void* D_NoConstructorClass__virtual_f2 = h2::h2_fp<D_NoConstructorClass, const char*(int, int)>::get(&d, &D_NoConstructorClass::virtual_f2);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f2);
      typedef const char*(TEST__thiscall * D_NoConstructorClass__virtual_f2_Type)(D_NoConstructorClass*, int, int);
      OK("D.virtual_f2(1,2)d", ((D_NoConstructorClass__virtual_f2_Type)D_NoConstructorClass__virtual_f2)(&d, 1, 2));

      void* D_NoConstructorClass__virtual_f3 = h2::h2_fp<D_NoConstructorClass, const char*(int, int, int)>::get(&d, &D_NoConstructorClass::virtual_f3);
      OK(Not(nullptr), D_NoConstructorClass__virtual_f3);
      typedef const char*(TEST__thiscall * D_NoConstructorClass__virtual_f3_Type)(D_NoConstructorClass*, int, int, int);
      OK("D.virtual_f3(1,2,3)d", ((D_NoConstructorClass__virtual_f3_Type)D_NoConstructorClass__virtual_f3)(&d, 1, 2, 3));
   }
