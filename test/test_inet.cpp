...
SUITE(SOCK)
{
   ...
   Case(UDP sendto recvfrom) 
   {
      ...
      OK(10, sent);
      OK(PktEq("0.0.0.0:9527", "1.2.3.4:8888", Me("1234567890", 10), 10), H2SOCK()); // Fetch outgoing packet

      H2SOCK("9876543210", 10, "4.3.2.1:4444"); // Inject as received packet from 4.3.2.1:4444
   ...
   Case(TCP server) {
      ...
      H2SOCK("", 0, "1.2.3.4:8888"); // Inject as Connected Signal from 1.2.3.4:8888
      l = sizeof(c);
      ...
      H2SOCK("9876543210", 10, "1.2.3.4:8888"); // Inject as received packet from 4.3.2.1:8888
