...
SUITE(Matches)
{
   ...
   Case(memcmp bytes)
   {
      ...
      h2::h2_memcmp_matches m(8, e, 8 * 8);
   ...
   Case(memcmp bits)
   {
      h2::h2_memcmp_matches m(1, "100011100010", -1);
   ...
   Case(memcmp shorts)
   {
      ...
      h2::h2_memcmp_matches m(32, e, 8 * 2 * 8);
   ...
   Case(memcmp ints)
   {
      ...
      h2::h2_memcmp_matches m(32, e, 8 * 4 * 8);
   ...
   Case(memcmp uint64)
   {
      ...
      h2::h2_memcmp_matches m(32, e, 8 * 8 * 8);
