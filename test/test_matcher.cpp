...
SUITE(Combine Matches)
{
   ...
   Case(Pointee)
   {
      h2::h2_pointee_matches<h2::h2_polymorphic_matcher<h2::h2_equal_matches<int>>> a(h2::h2_polymorphic_matcher<h2::h2_equal_matches<int>>{h2::h2_equal_matches<int>(65)});
   ...
   Case(Not)
   {
      h2::h2_not_matches<h2::h2_polymorphic_matcher<h2::h2_equal_matches<int>>> a1(h2::h2_polymorphic_matcher<h2::h2_equal_matches<int>>{h2::h2_equal_matches<int>(65)});
      OK(nullptr != a1.matches(65));
      OK(nullptr == a1.matches(66));

      h2::h2_not_matches<h2::h2_polymorphic_matcher<h2::h2_null_matches>> a2(h2::h2_polymorphic_matcher<h2::h2_null_matches>{h2::h2_null_matches()});
      OK(nullptr != a2.matches(nullptr));
      OK(nullptr == a2.matches(&int65));

      h2::h2_not_matches<h2::h2_polymorphic_matcher<h2::h2_contains_matches>> a3(h2::h2_polymorphic_matcher<h2::h2_contains_matches>{h2::h2_contains_matches("A")});
   ...
   Case(AllOf)
   {
      ...
      h2::h2_allof_matches<T1, T2> a(T1{h2::h2_null_matches()}, T2{h2::h2_any_matches()});
      OK(nullptr == a.matches(nullptr));
   }
   ...
   Case(AnyOf)
   {
      using T1 = h2::h2_polymorphic_matcher<h2::h2_null_matches>;
      using T2 = h2::h2_polymorphic_matcher<h2::h2_any_matches>;
      h2::h2_anyof_matches<T1, T2> a(T1{h2::h2_null_matches()}, T2{h2::h2_any_matches()});
      OK(nullptr == a.matches(nullptr));
      OK(nullptr == a.matches(NULL));
   }
