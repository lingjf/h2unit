...
SUITE(logic matches)
{
   ...
   Case(Not)
   {
      ...
      OK(nullptr != a1.matches(65, 0, false, false, false));
      OK(nullptr == a1.matches(66, 0, false, false, false));
      OK("≠65", a1.expection(false, false, false).string());
      ...
      OK(nullptr != a2.matches(nullptr, 0, false, false, false));
      OK(nullptr == a2.matches(&int65, 0, false, false, false));
      OK("NotNull", a2.expection(false, false, false).string());
      ...
      OK(nullptr != a3.matches("ABC", 0, false, false, false));
      OK(nullptr == a3.matches("BBC", 0, false, false, false));
   }
   ...
   Case(NoneOf)
   {
      ...
      OK(nullptr == a.matches(&int65, 0, false, false, false));
   }
}
